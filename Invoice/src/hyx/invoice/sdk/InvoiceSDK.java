...
public class InvoiceSDK {
	 ...
	 * 加载企业行业代码
	 * @param companyClass
	 *            企业行业代码 Map<String, Integer>结构 key=企业税号，value=行业代码
	 * @throws Exception
	 */
	 ...
	 *            进项明细 单个明细String
	 * @param outWord
	 *            经过initOutWords返回的销售明细 List<String>
	...
	public static double matchWord(String inWord, List<String> outWord) throws Exception {
		...
		double result = 0;
		try {
			result = Double.parseDouble(df.format(InvoiceNLP.matchInWord(inWord, outWord)));
		} catch (Exception e) {
	...
	public static void main(String[] args) throws Exception {
		...
		setDataPath("/Users/hyx/发票专票/test/");
		...
		List<String> outs = initOutWords(52, out);// 先加载这个公司的销售明细
		for (String test : in) {
